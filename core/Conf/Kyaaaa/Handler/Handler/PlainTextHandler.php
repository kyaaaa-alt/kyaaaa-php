...
use Core\Conf\Kyaaaa\Handler\Exception\Frame;

/**
* Handler outputing plaintext error messages. Can be used
* directly, or will be instantiated automagically by Core\App\Kyaaaa\Handler\Run
...
class PlainTextHandler extends Handler
{
     ...
     * @param  \Core\Conf\Kyaaaa\Handler\Exception\Frame $frame [description]
