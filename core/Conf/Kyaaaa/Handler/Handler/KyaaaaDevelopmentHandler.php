...
use Core\Conf\Kyaaaa\Handler\Exception\Formatter;
use Core\Conf\Kyaaaa\Handler\Util\Misc;
use Core\Conf\Kyaaaa\Handler\Util\TemplateHelper;

class KyaaaaDevelopmentHandler extends Handler
{
    ...
    public function handle()
    {
        ...
        $templateFile = $this->getResource("views/kyaaaa_dev.html.php");
     ...
     *
     * @return \Core\Conf\Kyaaaa\Handler\Exception\FrameCollection
     */
    ...
    public function addDataTableCallback($label, /* callable */ $callback)
    {
        ...
        $this->extraTables[$label] = function (\Core\Conf\Kyaaaa\Handler\Exception\Inspector $inspector = null) use ($callback) {
            try {
