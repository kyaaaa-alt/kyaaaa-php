...
namespace Core\Conf\Kyaaaa\Handler;

use InvalidArgumentException;
use Throwable;
use Core\Conf\Kyaaaa\Handler\Exception\ErrorException;
use Core\Conf\Kyaaaa\Handler\Exception\Inspector;
use Core\Conf\Kyaaaa\Handler\Handler\CallbackHandler;
use Core\Conf\Kyaaaa\Handler\Handler\Handler;
use Core\Conf\Kyaaaa\Handler\Handler\HandlerInterface;
use Core\Conf\Kyaaaa\Handler\Util\Misc;
use Core\Conf\Kyaaaa\Handler\Util\SystemFacade;
...
final class Run implements RunInterface
{
    ...
    public function register()
    {
        if (!$this->isRegistered) {
            ...
            class_exists("\\Core\Conf\Kyaaaa\Handler\\Exception\\ErrorException");
            class_exists("\\Core\Conf\Kyaaaa\Handler\\Exception\\FrameCollection");
            class_exists("\\Core\Conf\Kyaaaa\Handler\\Exception\\Frame");
            class_exists("\\Core\Conf\Kyaaaa\Handler\\Exception\\Inspector");
    ...
    /**
     * Unregisters all handlers registered by this Core\App\Kyaaaa\Handler\Run instance.
     *
     * @return Run
     */
    ...
    private function resolveHandler($handler)
    {
        ...
        if (!$handler instanceof HandlerInterface) {
            throw new InvalidArgumentException(
                ...
                . "Core\Conf\Kyaaaa\Handler\\Handler\\HandlerInterface"
            );
        }
